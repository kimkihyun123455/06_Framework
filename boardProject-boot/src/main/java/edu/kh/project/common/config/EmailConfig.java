...
public class EmailConfig {
	 ...
	 *	SMTP (Simple Mail Transfer Protocol) : 이메일을 전송하는데 사용되는 표준 통신 프로토콜
		...
		3. Google SMTP 서버가 이메일 주소에 맞는 수신자에게 이메일 서버를 통해 발송
		4. 최종 수신자가 이메일 받음
		
		(참고) 기본 포트 25를 사용하지만, 보안 강화한 포트 587이나 465를 자주 사용함
	...
	public JavaMailSender javaMailSender() {
		 ...
		 * JavaMailSenderImpl 클래스를 통해 구현된다
		...
		// Spring 애플리케이션에서 이메일을 보내기 위한 구성을 제공한다
		// 필요한 곳에서 의존성 주입받아 사용!
