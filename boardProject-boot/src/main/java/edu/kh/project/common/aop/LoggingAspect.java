...
public class LoggingAspect {
	...
	public void beforeController(JoinPoint jp) {
		...
		// [MainController.mainPage] 요청 / ip : xxx.xx.xx.xx
	...
	// * 주의할 점 * 
	// 1) @Around 사용 시 반환형이 Object 여야한다
	...
	public Object aroundServiceImpl(ProceedingJoinPoint pjp)throws Throwable {
		...
		// Throwable의 주요 자식으로 Exception(예외) - 개발자가 처리할 수 있는 문제
		// Error(오류) - 개발자가 처리 못하는 시스템 단위의 문제
		...
		// 서비스 코드 실행 시 시간 기록
		long startMs = System.currentTimeMillis(); // 현제 시간을 Ms 단위로 long 타입으로 반환
